...
public class StreamingVirtualTableTest extends CQLTester
{
    ...
    public void single() throws Throwable
    {
        ...
        state.handleStreamEvent(new StreamEvent.SessionPreparedEvent(state.id(), new SessionInfo(PEER2, 1, PEER1, Collections.emptyList(), Collections.emptyList(), StreamSession.State.PREPARING, null)));
